...
NSString * const UICKeyChainStoreErrorDomainString = @"com.kishikawakatsumi.uickeychainstore";
...
{
    NSError *error = [NSError errorWithDomain:UICKeyChainStoreErrorDomainString code:UICKeyChainStoreErrorInvalidArguments userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:UICKeyChainStoreErrorDomainString code:-67594 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
#endif
    NSError *error = [NSError errorWithDomain:UICKeyChainStoreErrorDomainString code:status userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:UICKeyChainStoreErrorDomainString code:-99999 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
