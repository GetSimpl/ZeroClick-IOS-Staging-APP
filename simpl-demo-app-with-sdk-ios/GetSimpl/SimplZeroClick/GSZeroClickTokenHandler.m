...
@interface GSZeroClickTokenHandler () <NSURLSessionDelegate>
...
@implementation GSZeroClickTokenHandler
...
-(void)generateToken {
    ...
    [[session dataTaskWithRequest:self.urlRequest completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        if (success) {
            ...
            self.completionBlock(jsonResponse,nil) ;
